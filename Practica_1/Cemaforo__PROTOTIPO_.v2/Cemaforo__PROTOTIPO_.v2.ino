...
void loop(){  // ciclo infinito ////r2.- vuelve a comenzar el ciclo y finaliza en (r2).
    ...
    delay(500);
    digitalWrite(led2,LOW);///apagar
    delay(500);           //Espera 0.5
    digitalWrite(led2,HIGH); ///PRENDE LED1
    delay(500);           //// apagar
    digitalWrite(led3,HIGH);
    delay(5000);
    digitalWrite(led3,LOW);
    delay(500);               // espera 0.5
    digitalWrite(led3,HIGH);  //prende led 1
    delay(500);
    digitalWrite(led3,LOW);///apagar
    delay(500);           //Espera 0.5
    digitalWrite(led3,HIGH); ///PRENDE LED1
    delay(500);           //// apagar
